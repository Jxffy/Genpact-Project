...
<body>
    ...
    <div class="container">
                ...
                <% 
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            ...
                            out.println("<a href='delete.jsp?acc_no=" + accountNo + "'>Delete</a>");
                            out.println("</td>");
        ...
        <div style="text-align: center; margin-top: 1rem;">
            <a href="admin.jsp" style="padding: 0.5rem 1rem; background-color: #007bff; color: white; border-radius: 4px; text-decoration: none;">Back to Dashboard</a>
        </div>
    </div>
</body>
</html>